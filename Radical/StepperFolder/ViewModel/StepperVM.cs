...
namespace Stepper
{
    ...
    public class StepperVM : BaseVM
    {
        ...
        public StepperVM(StepperComponent stepper, StepperDesign design)
        {
            ...
            int i = 0;
            foreach (double objValue in this.Design.Objectives)
            {
        ...
        //OPTIMIZE
        public void Optimize(Optimizer.Direction dir)
        {
            Optimizer optimizer = new Optimizer(this.Design, this.ObjIndex, dir, this.StepSize);
            optimizer.Optimize();
